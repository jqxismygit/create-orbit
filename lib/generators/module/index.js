...
class Generator extends BasicGenerator {
  ...
  writing() {
    ...
    console.log('end cwd = ', this.destinationPath(this.perfix, this.prompts.moduleName));
    ...
    console.log('end cwd 2 = ', this.destinationPath(this.perfix, this.prompts.moduleName));
